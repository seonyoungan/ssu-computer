...
img = np.full((400, 400, 3), 255, np.uint8) #캔버스 생성

def drawLines():
    # cv.line(img, point1, point2, color, border)
    cv.line(img, (50, 50), (200, 50), (0, 0, 255))
    cv.line(img, (50, 50), (200, 100), (255, 0, 255), 3)
    cv.line(img, (50, 150), (200, 150), (255, 0, 0), 10)

    # cv.line(img, point1, point2, color, border, markertype)
    cv.line(img, (250, 50), (350, 100), (0, 0, 255), 1, cv.LINE_4)
    cv.line(img, (250, 70), (350, 120), (255, 0, 255), 1, cv.LINE_8)
    cv.line(img, (250, 90), (350, 140), (255, 0, 0), 1, cv.LINE_AA) #젤 매끄러운선

    #화살표선
    cv.arrowedLine(img, (50, 200), (150, 200), (0, 0, 255), 1)
    cv.arrowedLine(img, (50, 250), (350, 250), (255, 0, 255), 1)
    cv.arrowedLine(img, (50, 300), (350, 300), (255, 0, 0), 1, cv.LINE_8, 0, 0.05) #화살표꼭대기(>)부분 얕게조정(?)

    #온갖 종류의 마커
    cv.drawMarker(img, (50, 350), (255, 0, 0), cv.MARKER_CROSS) # +
    cv.drawMarker(img, (100, 350), (255, 0, 0), cv.MARKER_TILTED_CROSS)
    cv.drawMarker(img, (150, 350), (255, 0, 0), cv.MARKER_STAR)
    cv.drawMarker(img, (200, 350), (255, 0, 0), cv.MARKER_DIAMOND)
    cv.drawMarker(img, (250, 350), (255, 0, 0), cv.MARKER_SQUARE)
    cv.drawMarker(img, (300, 350), (255, 0, 0), cv.MARKER_TRIANGLE_UP)
    cv.drawMarker(img, (350, 350), (255, 0, 0), cv.MARKER_TRIANGLE_DOWN)
...
def drawPolys():
    ...
    cv.rectangle(img, (50, 150), (150, 200), (0, 0, 128), -1)  # 0미만의 수는 셀이 채워진다

    # 원
    cv.circle(img, (300, 100), 30, (255, 255, 0), -1, cv.LINE_AA)
    cv.circle(img, (300, 100), 60, (255, 128, 0), 3, cv.LINE_AA)

    # 타원
    cv.ellipse(img, (120, 300), (60, 30), 20, 0, 270, (255, 128, 0), cv.FILLED, cv.LINE_AA)
    cv.ellipse(img, (120, 300), (100, 50), 20, 0, 360, (0, 255, 0), cv.LINE_AA)

    # 다각형
    pts = np.array([[250, 250], [300, 250], [300, 300], [350, 300], [350, 350], [250, 350]])
    cv.polylines(img, [pts], True, (255, 128, 0), 2)
